...
DeadCell::DeadCell(point center, unsigned int width, unsigned int height) : Cell({0, 0, 0}, center, width, height){
    hoverFill = {200, 200, 200};
    originalFill = fill;
}

void DeadCell::draw() const{
...
bool DeadCell::change(Cell &TopLeft, Cell &Top, Cell &TopRight, Cell &Right, Cell &BottomRight, Cell &Bottom, Cell &BottomLeft, Cell&Left) const{
